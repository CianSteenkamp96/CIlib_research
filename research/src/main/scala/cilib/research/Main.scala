    ...
    if(args.length == 5)
      if(args(3) == "WFG"){
        ...
        if(args(4).toInt != 1 && args(4).toInt != 2 && args(4).toInt != 3 && args(4).toInt != 4 && args(4).toInt != 5 && args(4).toInt != 6 && args(4).toInt != 7)
          throw new Exception("The fifth CL parameter (the problem number), for DTLZ, should be: 1, 2, ..., or 7.\n")
      } else if(args(3) == "ZDT"){
        if(args(4).toInt != 1 && args(4).toInt != 2 && args(4).toInt != 3 && args(4).toInt != 4 && args(4).toInt != 6)
          throw new Exception("The fifth CL parameter (the problem number), for ZDT, should be: 1, 2, 3, 4, or 6.\n")
